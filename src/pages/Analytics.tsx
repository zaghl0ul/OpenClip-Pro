...
const Analytics = () => {
  ...
  const getTrendIcon = (trend) => {
    switch (trend) {
      case 'up':
        return <ArrowUp size={16} className="w-4 h-4 text-green-500" />;
      case 'down':
        return <ArrowDown size={16} className="w-4 h-4 text-red-500" />;
      default:
        return <Minus size={16} className="w-4 h-4 text-gray-500" />;
    }
  };
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          <Icon size={24} className="w-6 h-6 text-blue-600 dark:text-blue-400" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-2">
                <div size={12} className="w-3 h-3 bg-blue-500 rounded-full"></div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-2">
                <div size={12} className="w-3 h-3 bg-green-500 rounded-full"></div>
        ...
        >
          ...
          <div className="space-y-4">
            {analyticsData.topPerformers.map((item, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div size={32} className="w-8 h-8 bg-blue-100 dark:bg-blue-900/20 rounded-full flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-full w-fit mx-auto mb-4">
              <Video size={32} className="w-8 h-8 text-blue-600 dark:text-blue-400" />
            </div>
          ...
          >
            <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-full w-fit mx-auto mb-4">
              <BarChart3Icon size={32} className="w-8 h-8 text-green-600 dark:text-green-400" />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">
          ...
          >
            <div className="p-3 bg-purple-50 dark:bg-purple-900/20 rounded-full w-fit mx-auto mb-4">
              <UsersIcon size={32} className="w-8 h-8 text-purple-600 dark:text-purple-400" />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">
