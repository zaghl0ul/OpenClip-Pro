      ...
      >
        ...
        >
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
            ...
            <div className="mb-6">
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
                {glassEffects.map(({ name, label, icon: Icon, color }) => (
                  ...
                  >
                    <Icon
                      className={`w-5 h-5 mx-auto mb-2 ${activeEffect === name ? color : 'text-subtle'}`}
                    />
            ...
            <div
              id="glass-demo-area"
              className="relative rounded-xl overflow-hidden bg-gradient-to-br from-primary/20 to-accent/20 p-8"
            >
              {/* Background Pattern */}
