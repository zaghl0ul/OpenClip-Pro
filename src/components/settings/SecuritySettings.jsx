...
const SecuritySettings = () => {
  const { security, updateSecuritySetting, clearAllSettings } = useSettingsStore();
  ...
  const handleClearAllData = withErrorHandling(
    async () => {
      try {
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3 mt-4">
              <p className="text-sm text-red-400 font-medium">
                Warning: This action is irreversible and will require you to reconfigure the
                application.
              </p>
            </div>
          </div>
  ...
  return (
    <div className="space-y-6">
      <div className="card p-6">
        <h3 className="text-lg font-semibold text-gray-100 mb-4">Privacy & Security</h3>
        ...
        <div className="mt-6 pt-4 border-t border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Remove all projects, settings, and cached data
              </p>
            </div>
            <button
